...
final Color mainClr = Color.fromARGB(255, 159, 201, 221);
final Color secondClr = Color.fromARGB(255, 78, 125, 150);
final Color thirdClr = Color.fromARGB(255, 255, 132, 75);
final Color bgClr = Color.fromARGB(255, 227, 237, 242);
final Color readClr = Color.fromARGB(255, 10, 13, 37);
